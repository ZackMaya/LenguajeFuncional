...
'hola                       ;----> 'hola
(quote hola)                ;----> 'hola
(symbol? 'hola-que<>)       ;---->  #t, predicado que detemrina si el párametro es un símbolo
(symbol-string 'hola-que<>) ;---->  "hola-que<>"
'mañana                     ;----> 'mañana
'lápiz                      ;----> 'lápiz
(symbol? 'hola)             ;----> #t
(symbol? "hola")            ;----> #f
...
;(define valor 5)
;(define valor 10)           ;----> No esposible definir dos veces la misma variable


;Ejemplo: Realiza un programa que cálcule el área de un anillo, dados los radios de las circunferencias que lo forman 
;(define (<identificador-funcion> <parametros>...<parametro n>)
...
(define (area-anillo radio1 radio2)
  (- (area-circunferencia radio1)
     (area-circunferencia radio2)))

;área-circunferencia: número --> número
;área-circunferencia: cálcula el área de una circunferencia con radio r



;área-anillo: número X número ---->
;área.anillo: cálcula el área de un anillo formado por las circunferencias de radio y radio2, respectivamente
